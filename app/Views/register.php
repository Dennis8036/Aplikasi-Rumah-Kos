...
<body>
  <div class="container-scroller">
    <div class="container-fluid page-body-wrapper full-page-wrapper">
      <div class="content-wrapper d-flex align-items-center auth lock-full-bg" style="background-image: url('../../images/img/hd.webp'); background-size: cover; background-position: center;">
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center mb-3">
                                    <?php if (!empty($setting->logo_login)): ?>
                                        <img src="<?= base_url('images/img/' . $setting->logo_login) ?>" alt="Login Icon"
                                             class="img-fluid mb-3 logo-login" style="max-width: 130px;">
                                    <?php endif; ?>
                                </div>
              <h4>New here?</h4>
